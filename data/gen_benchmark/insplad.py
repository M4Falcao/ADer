...
class InsPLADSolver(object):
    CLSNAMES = [
        'glass-insulator', 'lightning-rod-suspension', 'polymer-insulator-upper-shackle',
        'vari-grip', 'yoke-suspension',
    ]

    def __init__(self, root='data/insplad-seg'):
        self.root = root
...
if __name__ == '__main__':
    runner = InsPLADSolver(root='data/insplad-seg')
    runner.run()
